...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-black text-zinc-900 dark:text-white relative overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute top-1/3 right-1/4 w-64 h-64 bg-purple-600 rounded-full filter blur-[130px] opacity-10 dark:opacity-10 pointer-events-none" />
        ...
        <div className="max-w-6xl mx-auto px-4 py-12">
          ...
          <div className="bg-zinc-50 dark:bg-white/5 backdrop-blur-xl border border-zinc-200 dark:border-white/10 rounded-2xl p-8 mb-8 shadow-2xl transition-colors duration-300">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              ...
              <div className="md:text-right bg-white dark:bg-white/5 p-4 rounded-xl border border-zinc-200 dark:border-white/5 transition-colors duration-300">
                ...
                <p className="text-xl font-bold text-indigo-600 dark:text-indigo-400 mt-1">{profile?.mobile_number}</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Link href="/typing-test/english/junior" className="group bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white p-6 rounded-2xl shadow-lg transition-all duration-300 font-bold flex items-center justify-between">
                <div>
                  <p className="text-xl">Launch Practice Test</p>
                  <p className="text-xs font-normal text-indigo-100 mt-1">Improve your English WPM and precision</p>
                </div>
                <div className="p-2 bg-white/20 rounded-lg group-hover:translate-x-1 transition-transform">→</div>
              </Link>
