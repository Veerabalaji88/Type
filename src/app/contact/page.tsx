...
export default function ContactUs() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const adminPhone = '916383032090';

    const textMessage = `Hello Central School of Commerce,\n\n` +
      `I have a query.\n` +
      `*Name:* ${formData.name}\n` +
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black text-zinc-900 dark:text-white relative overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute top-1/3 right-1/4 w-64 h-64 bg-purple-600 rounded-full filter blur-[120px] opacity-10 dark:opacity-10 pointer-events-none" />

      <div className="relative z-10">
        {user ? <Navbar /> : (
          <nav className="bg-white dark:bg-black border-b border-zinc-200 dark:border-white/10 shadow-lg transition-colors duration-300">
            <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
              <Link href="/" className="text-xl font-bold tracking-tight text-zinc-900 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                Central School
              </Link>
              <div className="flex gap-4">
                ...
                <Link href="/signup" className="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg font-semibold transition-colors shadow-[0_0_15px_rgba(79,70,229,0.3)]">
                  Sign Up
                </Link>
              </div>
            </div>
        ...
        <div className="max-w-2xl mx-auto px-4 py-12">
          ...
          <div className="bg-zinc-50 dark:bg-white/5 backdrop-blur-xl border border-zinc-200 dark:border-white/10 rounded-2xl p-8 shadow-2xl mb-12 transition-colors duration-300">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 rounded-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg hover:shadow-indigo-500/20"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <a
              href="mailto:veerabalaji88@gmail.com"
            ...
            >
              ...
              <p className="text-indigo-600 dark:text-indigo-400 break-all text-xs font-mono">veerabalaji88@gmail.com</p>
            </a>

            <a
              href="https://maps.app.goo.gl/etEk4kgUaDhpgEuJ8"
              target="_blank"
            ...
            >
              ...
              <p className="text-indigo-600 dark:text-indigo-400 text-xs">No.130, Near Harvipatti Park, Harvipatti, Madurai – 625 005.</p>
            </a>
            ...
            <div className="bg-zinc-50 dark:bg-white/5 backdrop-blur-md border border-zinc-200 dark:border-white/10 p-6 rounded-2xl shadow-lg text-center flex flex-col items-center hover:bg-white dark:hover:bg-white/10 hover:-translate-y-1 transition-all duration-300 group transition-colors duration-300">
              ...
              <div className="flex flex-col gap-1 text-xs">
                <a href="tel:+916383032090" className="text-indigo-600 dark:text-indigo-400 hover:underline">+91 63830 32090</a>
                <a href="tel:+918973120153" className="text-indigo-600 dark:text-indigo-400 hover:underline">+91 89731 20153</a>
              </div>
            </div>
          </div>
        </div>
